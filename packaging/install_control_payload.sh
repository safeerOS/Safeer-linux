...
for modul in link_daljinec link_datoteke link_deljenje link_urejanje link_fokus link_hub link_hub_streznik link_iskanje link_krog link_mediji link_plosek link_programi link_ws \
